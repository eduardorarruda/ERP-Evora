@extends('default.layout',['title' => 'Lançamento Recorrente'])
@section('content')
<div class="page-content">
    <div class="card ">
        <div class="card-body p-4">
            ...
            <div class="col">
                <h6 class="mb-0 text-uppercase">Lançamento Recorrente</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 text-left ">
                        ...
                        <a id="clear-filter" class="btn btn-danger" href="{{ route('lancamento-recorrente.index') }}"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('conta-receber.destroy', $item->id) }}" method="post"
                                                ...
                                                @if(!$item->status)
                                                @if(!$item->boleto)
                                                <a title="Editar" href="{{ route('conta-receber.edit', $item) }}"
                                                ...
                                                <a title="Receber" href="{{ route('conta-receber.pay', $item) }}"
