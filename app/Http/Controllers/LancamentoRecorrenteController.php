...
class LancamentoRecorrenteController extends Controller
{
    ...
    {
        $clientes = ContaReceber::where('empresa_id', request()->empresa_id)->get();
        ...
        return view('lançamentos_recorrentes.index', compact('data', 'clientes', 'filial_id'));
    }*/
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categorias = CategoriaConta::where('empresa_id', $request->empresa_id)
            ...
            ->orderBy('nome')
            ->get();
        return view('lançamentos_recorrentes.edit', compact(
            'categorias',
            'item',
            'paises',
            'grupos',
    ...
    public function pay($id)
    {
        ...
        return view('lançamentos_recorrentes.pay', compact('item'));
    }
